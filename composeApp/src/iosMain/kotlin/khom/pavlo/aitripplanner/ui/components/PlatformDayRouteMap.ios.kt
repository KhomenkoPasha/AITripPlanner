...
actual fun PlatformDayRouteMap(
    ...
    val delegate = remember { DayRouteMapDelegate() }
        ...
        UIKitView(
            ...
            update = { currentMapView ->
                ...
                when (stops.size) {
                    ...
                    1 -> {
                        ...
                        currentMapView.setRegion(
                            region = MKCoordinateRegionMakeWithDistance(
                                CLLocationCoordinate2DMake(stop.latitude, stop.longitude),
                                1400.0,
                                1400.0,
                            ),
                            animated = false,
                    ...
                    else -> currentMapView.showAnnotations(
                        annotations = currentMapView.annotations,
                        animated = false,
                    )
                }
            },
...
private class DayRouteMapDelegate : NSObject(), MKMapViewDelegateProtocol {
    override fun mapView(
        mapView: MKMapView,
        viewForAnnotation: MKAnnotationProtocol,
    ): MKAnnotationView? {
        val pointAnnotation = viewForAnnotation as? MKPointAnnotation ?: return null
        val identifier = "day-route-stop"
        val markerView = (mapView.dequeueReusableAnnotationViewWithIdentifier(identifier) as? MKMarkerAnnotationView)
        ...
        markerView.glyphText = pointAnnotation.subtitle
        markerView.markerTintColor = UIColor.colorWithRed(
            red = 0.14,
            green = 0.12,
            blue = 0.10,
            alpha = 1.0,
